export const productsDB = [
  ...
  { name: "Formal Shirt", category: "male", type: "shirt", color: "white", price: 1500, discount: 18, image: "http://localhost:3004/products/shirt_1_1.webp" },
  { name: "Casual Shirt", category: "female", type: "shirt", color: "brown", price: 1350, discount: 12, image: "http://localhost:3004/products/shirt_2_1.webp" },
  { name: "Linen Shirt", category: "male", type: "shirt", color: "blue", price: 1450, discount: 10, image: "http://localhost:3004/products/shirt_3_1.webp" },
  { name: "Denim Shirt", category: "male", type: "shirt", color: "yellow", price: 1400, discount: 15, image: "http://localhost:3004/products/shirt_4_1.webp" },
  { name: "Plaid Shirt", category: "female", type: "shirt", color: "white", price: 1300, discount: 20, image: "http://localhost:3004/products/shirt_5_1.webp" },

  // Футболки (T-shirt) - 5 товарів
  { name: "Basic T-shirt", category: "female", type: "tshirt", color: "pink", price: 800, discount: 5, image: "http://localhost:3004/products/tshirt_1_1.webp" },
  { name: "Graphic T-shirt", category: "male", type: "tshirt", color: "yellow", price: 850, discount: 10, image: "http://localhost:3004/products/tshirt_2_1.webp" },
  { name: "Sport T-shirt", category: "male", type: "tshirt", color: "black", price: 900, discount: 12, image: "http://localhost:3004/products/tshirt_3_1.webp" },
  { name: "Slim Fit T-shirt", category: "male", type: "tshirt", color: "white", price: 880, discount: 8, image: "http://localhost:3004/products/tshirt_4_1.webp" },
  { name: "Vintage T-shirt", category: "male", type: "tshirt", color: "black", price: 950, discount: 15, image: "http://localhost:3004/products/tshirt_5_1.webp" }
];